...
export const WalletConnectProvider: React.FC<WalletConnectProviderProps> = ({
  ...
  const handleSignTransaction = async (
    ...
    return new Promise((_resolve, reject) => {
      console.log('🔗 WalletConnect: handleSignTransaction', params);
      // ACCOUNT ABSTRACTION COMPATIBILITY:
      // eth_signTransaction is not compatible with Account Abstraction wallets
      // AA wallets use UserOperations instead of traditional transactions
      console.error(
        '❌ eth_signTransaction not supported for Account Abstraction wallets',
      );

      displayMessage(
        'error',
        t('home:walletconnect.eth_sign_transaction_not_supported'),
      );

      reject(new Error(t('home:walletconnect.eth_sign_transaction_error')));
    });
  };
