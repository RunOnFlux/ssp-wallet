...
function BuyAndSellCrypto(props: {
  open: boolean;
  ...
  return (
    <>
      ...
      >        
        {
          <iframe        
            src={`https://buy.onramper.com?defaultCrypto=${crypto}&apiKey=pk_prod_01JDMCZ0ZRZ14VBRW20B4HC04V&mode=buy,sell`}
            title="Onramper"
            height="600px"
            width="380px"
...
export default BuyAndSellCrypto;
