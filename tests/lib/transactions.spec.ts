...
describe('Transactions Lib', () => {
  describe('Verifies transactions', () => {
    ...
    it('should return fetchAllAddressTransactions data when value is evm', async () => {
      ...
      expect(res.length).toBeGreaterThan(55);
      expect(res[0]).not.toBeNull();
      expect(res[0]).toBeDefined();
      expect(res[0].fee).not.toBeNull();
      expect(res[0].fee).toBeDefined();
      ...
      expect(res[0].blockheight).not.toBeNull();
      expect(res[0].blockheight).toBeDefined();
      expect(res[0].timestamp).not.toBeNull();
      expect(res[0].timestamp).toBeDefined();
      expect(res[0].message).toBe('');
      expect(res[0].receiver).not.toBeNull();
      expect(res[0].receiver).toBeDefined();
    }, 5000);

    it('should return fetchAllAddressTransactions data when value is utxo insight', async () => {
      const res = await fetchAllAddressTransactions(
    ...
    it('should return fetchAllAddressTransactions data when value is utxo blockbook', async () => {
      const res = await fetchAllAddressTransactions(
    ...
    it('should return fetchAddressTransactions data when value is utxo insight', async () => {
      const res = await fetchAddressTransactions(
        't1cjcLaDHkNcuXh6uoyNL7u1jx7GxvzfYAN',
        'flux',
        1,
    ...
    it('should return fetchAddressTransactions data when value is utxo blockbook', async () => {
      const res = await fetchAddressTransactions(
        'bc1pv537rf60ayvhdj2ysdy70vl2w9sqtq2taqp2zx8y6smyj38m4spsr8d3uq',
        'btc',
        1,
    ...
    it('should return decodeTransactionForApproval data when value is valid', () => {
      const res = decodeTransactionForApproval(
        rawTxFlux,
        'flux',
        't1cjcLaDHkNcuXh6uoyNL7u1jx7GxvzfYAN',
      );
