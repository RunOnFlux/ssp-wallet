...
- `ssp-wallet-chrome-v1.35.0.zip` - Chrome Web Store package
- `ssp-wallet-firefox-v1.35.0.zip` - Firefox Add-ons package  
...
# - ssp-wallet-chrome-v1.35.0.zip
# - ssp-wallet-firefox-v1.35.0.zip  
# - SHA256SUMS
```
