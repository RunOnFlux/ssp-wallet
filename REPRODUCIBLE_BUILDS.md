...
- `ssp-wallet-chrome-v1.25.3.zip` - Chrome Web Store package
- `ssp-wallet-firefox-v1.25.3.zip` - Firefox Add-ons package  
...
# - ssp-wallet-chrome-v1.25.3.zip
# - ssp-wallet-firefox-v1.25.3.zip  
# - SHA256SUMS
```
