...
- `ssp-wallet-chrome-v1.26.2.zip` - Chrome Web Store package
- `ssp-wallet-firefox-v1.26.2.zip` - Firefox Add-ons package  
...
# - ssp-wallet-chrome-v1.26.2.zip
# - ssp-wallet-firefox-v1.26.2.zip  
# - SHA256SUMS
```
