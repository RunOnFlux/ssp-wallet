...
- `ssp-wallet-chrome-v1.34.1.zip` - Chrome Web Store package
- `ssp-wallet-firefox-v1.34.1.zip` - Firefox Add-ons package  
...
# - ssp-wallet-chrome-v1.34.1.zip
# - ssp-wallet-firefox-v1.34.1.zip  
# - SHA256SUMS
```
